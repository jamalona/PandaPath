...
const LoginForm = ({setToken}) => {
  ...
  return (
    <div className='h-lvh relative pt-32'>
      ...
      <form onSubmit={handleSubmit} className='bg-black -mt-9 text-white bg-opacity-30 backdrop-blur-lg min-w-96 w-4/12 ml-auto mr-auto h-4/5 rounded-2xl border border-white'>
